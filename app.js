...
$(document).ready(function () {
    ...
    $('.vypln').submit(function (e) {
        ...
        $.ajax(settings).done(function (response) {
            ...
            $("#result_city").append(searched_city).css("text-transform", "lowercase");
    ...
    $("#map_button_open").click(function () {
        ...
        if (search_flag) { //oddelit vykreslovaci funkci jinam a pak ji schovat pod podminku pokud uz mapa byla vykreslena :) 
